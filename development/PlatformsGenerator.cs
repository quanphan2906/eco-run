...
public class PlatformsGenerator : MonoBehaviour
{
    ...
    public CoinGenerator theCoinGnenerator;
    ...
    void Start()
    {
        ...
        theCoinGnenerator = FindObjectOfType<CoinGenerator>();
    }
    ...
    void Update()
    {
        if (transform.position.x < generationPoint.position.x)
        {
            ...
            {
                theCoinGnenerator.SpawnCoins(new Vector3(transform.position.x, transform.position.y + 1f, transform.position.z));
            }
